...
const confirm = window.confirm('Are you sure to delete this car? brooo!!!!')
...
<img src={car.image} alt="" className='h-30 w-45 aspect-square rounded-md object-cover' />
...
<td className='p-3 max-md:hidden'>
  <span className={`px-3 py-1 rounded-full text-xs ${car.isAvailable ? "bg-green-400" : "bg-red-600"  } `}>
    {car.isAvailable ? "Available" : "Unavailable"}
  </span>
</td>
<td className='flex items-center p-9'>
