...
<form onSubmit={onSubmitHandler } onClick={(z)=>z.stopPropagation()} className="flex flex-col gap-4 m-auto items-start p-8 py-12 w-80 sm:w-[352px] rounded-lg shadow-xl border border-gray-200 bg-white">
            ...
            <button className="bg-cyan-950 hover:bg-orange-600 transition-all text-white w-full py-2 rounded-md cursor-pointer">
