...
navigate('/cars?pickupLocation=' +pickupLocation +'&pickupDate=' + pickupDate + '&returnDate=' +returnDate)
  ...
  return (
    ...
    className='h-screen flex flex-col items-center justify-center gap-14 bg-slate-600  text-center'>
      <motion.h1 
...
{/* return date */}
 ...
 className='flex items-center justify-center gap-1 px-9 py-3 max-sm:mt-4 bg-primary hover:bg-primary-dull text-white rounded-full cursor point'>
    ...
    transition={{ duration: 0.8, delay: 0.6}}
      ...
      src={assets.main_car} alt="car" className='max-h-84' />
    </motion.div>
  )
}
