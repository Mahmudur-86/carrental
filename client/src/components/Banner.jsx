...
<p className='max-w-130'>We take care of insurance, driver verification and secure payments, so you can earn passive income, stress free. hurrayyyyy!!!!!</p>

<motion.button
whileHover={{scale: 1.05}}
whileTap={{scale: 0.95}}

className='px-6 py-2 bg-white hove:bg-slate-100 transition-all text-primary rounded-lg text-sm mt-4 cursor-pointer '>List your Car</motion.button>
